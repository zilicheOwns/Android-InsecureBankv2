...
content = open(__file__).read().split('### SCANNER START ###')[1].split('### SCANNER END ###')[0]
with open('security_scanner.py', 'w') as f:
    f.write(content)
os.chmod('security_scanner.py', 0o755)
print("Scanner generated!")
os.system('python3 security_scanner.py')
